...
const Circle = forwardRef(function Circle({ className, children, ariaLabel }, ref) {
    return (
      <div
        ref={ref}
        className={cn(
          'z-10 flex size-12 items-center justify-center rounded-full border-2 border-accent bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]',
          className
        )}
  ...
  export default function AiAutomationAnimate() {
    ...
    return (
      <div
        className="relative flex h-[40vh] min-h-[300px] w-full max-w-[600px] items-center justify-center overflow-hidden p-4 sm:p-10"
        ref={containerRef}
      >
        <div className="flex size-full max-w-[600px] flex-col items-stretch justify-between gap-6 sm:gap-10">
          <div className="flex flex-row items-center justify-between">
            <Circle ref={div1Ref} ariaLabel="Google Drive">
              <Icons.googleDrive />
            </Circle>
            <Circle ref={div5Ref} ariaLabel="Google Docs">
              <Icons.googleDocs />
            </Circle>
          </div>
          <div className="flex flex-row items-center justify-between">
            <Circle ref={div2Ref} ariaLabel="Notion">
              <Icons.notion />
            </Circle>
            <Circle ref={div4Ref} className="size-16" ariaLabel="OpenAI">
              <Icons.openai />
            </Circle>
            <Circle ref={div6Ref} ariaLabel="Zapier">
              <Icons.zapier />
            </Circle>
          </div>
          <div className="flex flex-row items-center justify-between">
            <Circle ref={div3Ref} ariaLabel="WhatsApp">
              <Icons.whatsapp />
            </Circle>
            <Circle ref={div7Ref} ariaLabel="Messenger">
              <Icons.messenger />
            </Circle>
          </div>
        </div>
...
const Icons = {
  ...
  zapier: () => (
    <svg  height="25" width="25" viewBox="0 0 256 351" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill="#FFA712" d="M1.253 280.732l1.605-3.131 99.353-188.518-44.15-83.475C54.392-1.283 45.074.474 43.87 8.188L1.253 280.732z"/>
